...
//{
// /// <summary>
// /// Класс контрола просмотра коллекции строк (базовый вариант).
// /// </summary>
// public class CtrlViewDocLinesDic : SimControlsGrid
// {
//  private Type lineType = null;
//  private DictionaryBinder dicBinder = null;
...
//  /// Коллекция строк
//  /// </summary>
//  public DictionaryBinder DicBinder
//  {
//   get { return dicBinder; }
//   set
//   {
//    dicBinder = value;
//    Fill();
...
//  /// </summary>
//  public CtrlViewDocLinesDic(DictionaryBinder dicBinder)
//   : this()
//  {
//   this.dicBinder = dicBinder;
//   Fill();
//  }
//  //-------------------------------------------------------------------------------------
...
//    object obj = null;
//    foreach(DictionaryEntry o in dicBinder)
//    {
//     obj = o.Value;
//     break;
//    }
//    if(obj == null)
//     lineType = dicBinder.Dic.GetType().GetGenericArguments()[0];
//    else
//     lineType = obj.GetType();

//    this.DataSource = dicBinder;
