...
namespace Sim.Controls
{
	...
	public partial class SimTreeViewEx : UserControl
	{
		...
		/// <summary>
		/// Делегат события AfterCheck
		/// </summary>
		/// <param name="sender">Объект, посылающий событие</param>
		/// <param name="e">Аргумент события</param>
		public delegate void AfterCheckHandler(object sender, ITreeItem e);
		/// <summary>
		/// Событие возникающее после установки или снятия отметки на узле
		/// </summary>
		[Description("Событие, возникающее после установки или снятия отметки на узле"), 
			Category("Own events")]
		...
		/// <summary>
		/// Делегат события BeforeCheck
		/// </summary>
		/// <param name="sender">Объект, посылающий событие</param>
		/// <param name="e">Аргумент события</param>
		public delegate void BeforeCheckHandler(object sender, CancelEventArgs<ITreeItem> e);
		/// <summary>
		/// Событие возникающее перед установкой или снятием отметки на узле
		/// </summary>
		[Description("Событие, возникающее перед установкой или снятием отметки на узле"),
			Category("Own events")]
					...
					case "toolStripMenuItemCount":
						{
							...
							l.Text = "Количество конечных элементов: " + _tree.GetEndItems(SelectedNodeItem).Count().ToString();
